...
public class UserEdtitionFormController {
    ...
    public String showUserForm(Model model, Principal name) {
    ...
    public String processUserForm(@ModelAttribute("userCommand") User userForm, @ModelAttribute("pass") String pass, Principal name) {
