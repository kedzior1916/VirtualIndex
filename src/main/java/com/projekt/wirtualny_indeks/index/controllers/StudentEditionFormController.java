...
public class StudentEditionFormController {
    ...
    public String showStudentForm1(Model model, int id) {
    ...
    public String showAdressForm(Model model, int id) {
        if(!studentService.getStudent(id).equals(null)){
    ...
    public String processAdressForm(@Valid @ModelAttribute("Adres") Adres adres, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return "editStudentForm2";
        }
