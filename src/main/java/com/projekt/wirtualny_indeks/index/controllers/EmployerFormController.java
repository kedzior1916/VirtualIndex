...
public class EmployerFormController {
    ...
    public String showEmployerForm(Model model,String token) {
    ...
    public String processEmployerForm(@Valid @ModelAttribute("regEmployer") Employer employer,@ModelAttribute("adress") Adres adres,@ModelAttribute("user") User user, BindingResult bindingResult) {
