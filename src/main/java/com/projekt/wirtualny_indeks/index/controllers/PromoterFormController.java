...
public class PromoterFormController {
    ...
    public String showPromoterForm(Model model, Optional<Integer> id) {
    ...
    public String processPromoterForm(@Valid @ModelAttribute("Promoter") Promoter promoter,BindingResult bindingResult) {
