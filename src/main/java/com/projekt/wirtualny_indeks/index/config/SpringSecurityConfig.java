...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                .antMatchers("/static/**", "/webjars/**", "/registrationForm.html", "/", "/error.html", "/css/**", "/images/**").permitAll()
                .antMatchers("/studentDetail.html").hasAnyRole("STUDENT", "DZIEKANAT","KIEROWNIK")
                .antMatchers("/pdfTemplate/").permitAll()
